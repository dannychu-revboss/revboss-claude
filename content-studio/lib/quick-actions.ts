...
export const QUICK_ACTIONS: { label: string; icon: string; prompt: string; needsInput?: boolean }[] = [
  ...
  { label: "Write a post", icon: "📝", prompt: "Write a full LinkedIn post for this client about: ", needsInput: true },
  ...
  { label: "Write from draft", icon: "✍️", prompt: "Rewrite the following rough draft in this client's voice, keeping their facts intact:\n\n", needsInput: true },
